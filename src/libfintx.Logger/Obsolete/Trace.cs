...
{
    [Obsolete("Create a logger class with library Microsoft.Extensions.Logging and use provider libfintx.Logger.FileLoggerProvider.CreateLibfintxLogger(). To manage if statements shall be written to file, see FinTsClient.WriteStatementsToFile.", true)]
