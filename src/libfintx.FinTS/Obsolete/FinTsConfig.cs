...
// Drop in next MAJOR VERSION UPGRADE
[Obsolete("Pass ILoggerFactory to FinTsClient to configure logging behavior. For managing if settlements shall be written to file, use FinTsClient.WriteSettmentsToFile", true)]
