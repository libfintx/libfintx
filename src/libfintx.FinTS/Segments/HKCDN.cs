...
namespace libfintx.FinTS
{
    public class HKCDN
    {
        ...
        /// </summary>
        public static async Task<String> Init_HKCDN(FinTsClient client, string OrderId, string Receiver,
        ...
        {
            client.Logger.LogInformation("Starting job HKCDN: Modify bankers order");
            ...
            segments += sEG.Delimiter + sEG.Delimiter + OrderId + sEG.Delimiter +
                FirstTimeExecutionDay.ToString("yyyyMMdd") + DEG.Separator + (char) timeUnit + DEG.Separator +
                Rota + DEG.Separator + ExecutionDay;
